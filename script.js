    ...
    div.innerHTML = `
      <div class="left space-y-3">
        ...
        <div class="buttons-container flex gap-2">
          <button
            class="interview-btn py-2 px-3 bg-white border border-[#10B981] rounded-lg text-green text-[#10B981] font-semibold cursor-pointer"
          >
            interview
          </button>
          <button
            class="reject-btn py-2 px-3 bg-white border border-[#EF4444] rounded-lg text-[14px] font-semibold text-[#EF4444] cursor-pointer"
          >
            Rejected
          </button>
        </div>
      ...
      <div class="right">
        <button
          class="delete-btn p-3 border border-gray-300 rounded-full bg-white text-gray-400 cursor-pointer"
        >
